...
type Manga struct {
	...
	// external source identifier (e.g., "local", "anilist", "kitsu", "mangadex")
	Source string `protobuf:"bytes,8,opt,name=source,proto3" json:"source,omitempty"`
	// direct URL to the manga resource on the source site
...
func (x *Manga) GetSourceUrl() string {
	if x != nil {
		return x.SourceUrl
	}
	return ""
...
type UpdateProgressRequest struct {
	...
	MangaTitle    string                 `protobuf:"bytes,3,opt,name=manga_title,json=mangaTitle,proto3" json:"manga_title,omitempty"`
	Chapter       int32                  `protobuf:"varint,4,opt,name=chapter,proto3" json:"chapter,omitempty"`
	Status        string                 `protobuf:"bytes,5,opt,name=status,proto3" json:"status,omitempty"` // e.g., "reading", "completed", "on_hold"
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *UpdateProgressRequest) GetMangaId() int64 {
	if x != nil {
		return x.MangaId
	}
	return 0
...
func (x *UpdateProgressRequest) GetMangaTitle() string {
	if x != nil {
		return x.MangaTitle
	}
	return ""
...
const file_manga_proto_rawDesc = "" +
	"\n" +
	"\vmanga.proto\x12\x02pb\"\xfc\x01\n" +
	"\x05Manga\x12\x0e\n" +
	...
	"\x0echapters_count\x18\a \x01(\x05R\rchaptersCount\x12\x16\n" +
	"\x06source\x18\b \x01(\tR\x06source\x12\x1d\n" +
	"\n" +
	"source_url\x18\t \x01(\tR\tsourceUrl\"S\n" +
	...
	"\x05manga\x18\x01 \x01(\v2\t.pb.MangaR\x05manga\"\x9e\x01\n" +
	"\x15UpdateProgressRequest\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\x12\x19\n" +
	"\bmanga_id\x18\x02 \x01(\x03R\amangaId\x12\x1f\n" +
	"\vmanga_title\x18\x03 \x01(\tR\n" +
	"mangaTitle\x12\x18\n" +
	...
	"\vSearchManga\x12\x11.pb.SearchRequest\x1a\x12.pb.SearchResponse\x12G\n" +
	"\x0eUpdateProgress\x12\x19.pb.UpdateProgressRequest\x1a\x1a.pb.UpdateProgressResponseB+Z)github.com/headtomatoes/mangahub/proto/pbb\x06proto3"
...
var file_manga_proto_goTypes = []any{
	...
	(*UpdateProgressRequest)(nil),  // 5: pb.UpdateProgressRequest
	(*UpdateProgressResponse)(nil), // 6: pb.UpdateProgressResponse
}
var file_manga_proto_depIdxs = []int32{
	...
	5, // 4: pb.MangaService.UpdateProgress:input_type -> pb.UpdateProgressRequest
	4, // 5: pb.MangaService.GetManga:output_type -> pb.GetMangaResponse
	2, // 6: pb.MangaService.SearchManga:output_type -> pb.SearchResponse
	6, // 7: pb.MangaService.UpdateProgress:output_type -> pb.UpdateProgressResponse
